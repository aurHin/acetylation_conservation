arg1<-commandArgs(T)[1] #sub.bed
arg2<-commandArgs(T)[2] #sub_onCSchr2.bed

setwd(dirname(arg1))
dir.create("../macs2_toPlot",showWarnings = F)
fileName<-basename(arg1)
outputName=paste0("../macs2_toPlot/",gsub(strsplit(fileName,"[.]")[[1]][1],paste0(strsplit(fileName,"[.]")[[1]][1],"_ConservationColumns"),fileName))
